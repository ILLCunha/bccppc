...
%Icaro: Seção nova com o CCD - a informção já existia, só não era particionada.
...
%Icaro: O correto seria como seção do capítulo 19:
% \section{Especificação dos profissionais do curso}
...
%Icaro: Não creio que a tabela a baixo seja necessária já que no modelo de PPC não tem ela.
\begin{center}
...
%Icaro: Não tenho a mínima ídeia se as informações dos 3 primeiros paragrafos estão corretas.
